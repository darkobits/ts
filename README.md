...
| [`vite`](https://github.com/vitejs/vite) | `^5.2.6`
| [`vitest`](https://github.com/vitest-dev/vitest) | `^1.4.0`
...
| [`npm-check-updates`](https://github.com/raineorshine/npm-check-updates) | `~16.14.18`
| [`@darkobits/nr`](https://github.com/darkobits/nr) | `~0.17.1`
